        ...
        _proto._invokeErrorHandler = function _invokeErrorHandler(
          ...
          if (error === NO_NETWORK_CONNECTION)
            (summary = fbt._("Kh\u00f4ng c\u00f3 K\u1ebft n\u1ed1i M\u1ea1ng")),
              (desc = fbt._(
                "C\u00f3 v\u1ebb nh\u01b0 tr\u00ecnh duy\u1ec7t c\u1ee7a b\u1ea1n \u0111ang offline. Vui l\u00f2ng ki\u1ec3m tra k\u1ebft n\u1ed1i Internet v\u00e0 th\u1eed l\u1ea1i."
              ));
          else if (error >= 300 && error <= 399) {
            summary = fbt._("\u0110\u1ecbnh h\u01b0\u1edbng l\u1ea1i");
            desc = fbt._(
              "Truy c\u1eadp c\u1ee7a b\u1ea1n v\u00e0o Facebook \u0111\u00e3 b\u1ecb m\u1ed9t b\u00ean th\u1ee9 ba \u0111\u1ecbnh h\u01b0\u1edbng l\u1ea1i ho\u1eb7c ch\u1eb7n t\u1ea1i th\u1eddi \u0111i\u1ec3m n\u00e0y, vui l\u00f2ng li\u00ean h\u1ec7 v\u1edbi Nh\u00e0 cung c\u1ea5p D\u1ecbch v\u1ee5 Internet (ISP) c\u1ee7a b\u1ea1n ho\u1eb7c t\u1ea3i l\u1ea1i."
            );
            ...
            (summary = fbt._("R\u1ea5t ti\u1ebfc")),
              (desc = fbt._(
                "\u0110\u00e3 x\u1ea3y ra l\u1ed7i. Ch\u00fang t\u00f4i \u0111ang kh\u1eafc ph\u1ee5c s\u1edbm nh\u1ea5t c\u00f3 th\u1ec3. B\u1ea1n c\u00f3 th\u1ec3 th\u1eed l\u1ea1i."
              ));
