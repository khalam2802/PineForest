...
!(function (R, Y, I, W, X) {
  R.fn.multiscroll = function (f) {
    ...
    w(),
      ...
      R(".ms-right").html(R(".ms-right").find(".ms-section").get().reverse()),
      R(".ms-left .ms-section, .ms-right .ms-section")
        .each(function () {
          ...
          R(this).css({ height: "100%" }),
            !e &&
              f.navigation &&
              s.find("li").eq(e).find("a").addClass("active");
        })
        .promise()
        .done(function () {
          R(".ms-left .ms-section.active").length ||
            (R(".ms-right").find(".ms-section").last().addClass("active"),
            R(".ms-left").find(".ms-section").first().addClass("active")),
    ...
    function b() {
      f.css3
        ? (T(
            R(".ms-left"),
            "translate3d(0px, -" +
              R(".ms-left").find(".ms-section.active").position().top +
              "px, 0px)",
            !1
          ),
          T(
            R(".ms-right"),
            "translate3d(0px, -" +
              R(".ms-right").find(".ms-section.active").position().top +
              "px, 0px)",
            !1
          ))
        : (R(".ms-left").css(
    ...
    function y(e) {
      ...
      (lastScrolledDestiny = o),
        (a = o),
        f.menu &&
          (R(f.menu).find(".active").removeClass("active"),
          R(f.menu)
        ...
        (r = t),
        f.navigation &&
          (R("#multiscroll-nav").find(".active").removeClass("active"),
          l
            ? R("#multiscroll-nav")
                .find('a[href="#' + l + '"]')
                .addClass("active")
    ...
    (o.destroy = function () {
      o.setKeyboardScrolling(!1),
        ...
        (i || n) &&
          (I.removeEventListener(t.touchstart, P),
          I.removeEventListener(t.touchmove, D, { passive: !1 })),
        R(Y).off("hashchange", c).off("resize", S),
        R(I)
      ...
      (o.build = function () {
        o.setKeyboardScrolling(!0),
          o.setMouseWheelScrolling(!0),
          z(),
          R(Y).on("hashchange", c).on("resize", S),
          R(I)
