...
!(function (a) {
  ...
  function y(a, b, c) {
    return b
      ? void (c.xSteps[a] =
          q([c.xVal[a], c.xVal[a + 1]], b) / p(c.xPct[a], c.xPct[a + 1]))
      : !0;
  }
  function z(a, b, c, d) {
    (this.xPct = []),
  ...
  function O(a) {
    var b,
      c = { margin: 0, limit: 0, animate: !0, format: T };
    b = {
      step: { r: !1, t: A },
      start: { r: !0, t: C },
      connect: { r: !0, t: F },
  ...
  function P(b, d) {
    ...
    function y(a, b, c) {
      ...
      function g(a, d) {
        aa.direction && (a = 100 - a),
          (d[1] = d[1] && b ? b(d[0], d[1]) : d[1]),
          (k += "<div " + f(a, da[21], d) + "></div>"),
          d[1] &&
            (k += "<div " + f(a, da[22], d) + ">" + c.to(d[0]) + "</div>");
      }
    ...
    function B(a, b, c) {
      void 0 !== b && 1 !== d.handles && (b = Math.abs(b - d.dir)),
        Object.keys(ca).forEach(function (d) {
          var e = d.split(".")[0];
          a === e &&
            ca[d].forEach(function (a) {
              a.call(
                Z,
                h(P()),
                b,
                h(C(Array.prototype.slice.call(ba))),
                c || !1,
                _
              );
            });
    ...
    function D(a, b, c, e) {
      var f = function (b) {
          return $.hasAttribute("disabled")
            ...
            ? !1
            : ((b = p(b, e.pageOffset)),
              a === R.start && void 0 !== b.buttons && b.buttons > 1
                ? !1
                : e.hover && b.buttons
                ? !1
    ...
    function H(a, b) {
      ...
      if (
        1 === b.handles.length &&
        (j(b.handles[0].children[0], da[15]),
    ...
    function I(a) {
      ...
      return (
        ...
        (b = h / 2 > g || 1 === Y.length ? 0 : 1),
        Y[b].hasAttribute("disabled") && (b = b ? 0 : 1),
        (g -= c(X)[d.style]),
        (e = (100 * g) / A()),
        d.events.snap || f($, da[14], 300),
        Y[b].hasAttribute("disabled")
          ? !1
          : (L(Y[b], e),
            B("slide", b, !0),
            B("set", b, !0),
            B("change", b, !0),
            void (d.events.snap && H(a, { handles: [Y[b]] })))
      );
    }
    function J(a) {
    ...
    function K(a) {
      ...
      if (!a.fixed)
        for (b = 0; b < Y.length; b += 1)
          D(R.start, Y[b].children[0], H, { handles: [Y[b]], handleNumber: b });
      if ((a.tap && D(R.start, X, I, { handles: Y }), a.hover))
        for (D(R.move, X, J, { hover: !0 }), b = 0; b < Y.length; b += 1)
          ["mousemove MSPointerMove pointermove"].forEach(function (a) {
            Y[b].children[0].addEventListener(a, n, !1);
          });
      a.drag &&
        ((c = [X.querySelector("." + da[7])]),
        j(c[0], da[10]),
        a.fixed && c.push(Y[c[0] === Y[0] ? 1 : 0].children[0]),
        c.forEach(function (a) {
          D(R.start, a, H, { handles: Y });
        }));
    }
    function L(a, b, c) {
      var e = a !== Y[0] ? 1 : 0,
        ...
        l = _[1] - d.limit;
      return (
        Y.length > 1 && (b = e ? Math.max(b, f) : Math.min(b, h)),
        c !== !1 &&
          d.limit &&
          Y.length > 1 &&
        ...
        b === _[e]
          ...
          : (window.requestAnimationFrame
              ...
              : (a.style[d.style] = b + "%"),
            a.previousSibling || (k(a, da[17]), b > 50 && j(a, da[17])),
            (_[e] = b),
            (ba[e] = aa.fromStepping(b)),
            B("update", e),
            !0)
      );
    }
      ...
      for (d.limit && (a += 1), c = 0; a > c; c += 1)
        (e = c % 2),
          ...
          null !== f &&
            ...
            (f === !1 ||
              isNaN(f) ||
              L(Y[e], aa.toStepping(f), c === 3 - d.dir) === !1) &&
              B("update", e));
    }
    function N(a) {
      var b,
    ...
    function W(a) {
      ...
      for (
        ["margin", "limit", "step", "range", "animate"].forEach(function (b) {
          void 0 !== a[b] && (d[b] = a[b]);
        }),
          e.spectrum.direction = aa.direction,
          aa = e.spectrum,
          _ = [-1, -1],
          N(c),
          b = 0;
  ...
  (z.prototype.getMargin = function (a) {
    ...
    (z.prototype.toStepping = function (a) {
      return (
        (a = u(this.xVal, this.xPct, a)), this.direction && (a = 100 - a), a
      );
    }),
    ...
    (z.prototype.getStep = function (a) {
      return (
        ...
        (a = w(this.xPct, this.xSteps, this.snap, a)),
        this.direction && (a = 100 - a),
        a
      );
    }),
