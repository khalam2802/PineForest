    ...
    (t.fn.prettyPhoto = function (p) {
      ...
      function m() {
        t(".pp_loaderIcon").hide(),
          (projectedTop =
            scroll_pos.scrollTop + (_ / 2 - o.containerHeight / 2)),
          projectedTop < 0 && (projectedTop = 0),
          $ppt.fadeTo(settings.animation_speed, 1),
          $pp_pic_holder
            .find(".pp_content")
            .animate(
              { height: o.contentHeight, width: o.contentWidth },
          ...
          $pp_pic_holder.animate(
            {
              top: projectedTop,
              left:
                g / 2 - o.containerWidth / 2 < 0
                  ? 0
                  : g / 2 - o.containerWidth / 2,
          ...
          "image" === y(pp_images[set_position])
            ? ((itemWidth = 57),
              ...
              (itemsPerPage = Math.floor(
                (o.containerWidth - 100 - navWidth) / itemWidth
              )),
              (itemsPerPage =
        ...
        settings.slideshow &&
          ...
          settings.allow_expand &&
            t("a.pp_expand").bind("click", function (e) {
              var i = t(this);
              return (
                i.hasClass("pp_expand")
                  ? (i.removeClass("pp_expand").addClass("pp_contract"),
                    (doresize = !1))
                  : (i.removeClass("pp_contract").addClass("pp_expand"),
                    (doresize = !0)),
                u(function () {
                  t.prettyPhoto.open();
                }),
      ...
      return (
        ...
        (t.prettyPhoto.open = function (e) {
          return (
            ...
            settings.hideflash &&
              t(
                "object,embed,video,iframe[src*=youtube],iframe[src*=vimeo]"
              ).css("visibility", "hidden"),
            ...
            1 === pp_images.length &&
              $pp_pic_holder.addClass("pp_pic_have_only_one"),
            ...
            $pp_pic_holder.fadeIn(function () {
              switch (
                ...
                case "html5":
                  (o = f(movie_width, movie_height)),
                    (toInject =
                      '<video preload="auto" autoplay><source type="video/mp4" src="' +
                      pp_images[set_position] +
                      '"></video>');
                  break;
                case "ajax":
